...
export default function QueryResultsView({ props }: { props: any }) {
    ...
    const { manufacturerList } = useSelector((state: RootState) => state.app);
    ...
    return (<>
        <div className="h-auto w-full overflow-auto ">
            <div className="w-full p-2 flex ">
                <Button title={'Back'} className="!border-1 !bg-[#ffffff70] !py-2 !px-1" onClick={goToHome}>Back</Button>
            </div>

            <div className="py-[2rem] px-[2rem] max-w-[1100px] mx-auto card" >
